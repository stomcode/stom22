...
function Links({navigation}) {
 ...
 return (
  ...
  <Divider style={{marginTop:10,width:400}} />
      ...
      onPress={() => Linking.openURL('https://realpython.com/python-command-line-arguments/')}>
    Real Python
   </Text>
   </View>
 ...
 W3school
   ...
   <Divider style={{marginTop:10,width:400}} />
        ...
        <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://www.programiz.com/python-programming')}>
 Programiz
   </Text>
   </View>
   <Divider style={{marginTop:10,width:400}} />
        ...
        <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://scrimba.com/learn/python')}>
   Scrimba
   </Text>
   </View>
   </View>
