...
<Image 
source={{
uri:'https://static.noroff.no/cms/ansatte/krs/johan-van-niekerk.jpg?alt=media&token=53ab19ff-2548-487a-85fd-2929f69aada1'
}} 
style={{width: 150, height: 150, borderRadius: 400/ 2}} 
/>
<Text style={styles.heading}>Prof. Johan van Niekerk</Text>
<Text style={styles.heading2}> Professor</Text>
<Text style={styles.heading3}
