 ...
 return (
  ...
  <View style={styles.cont}>
   ...
   <Divider style={{marginTop:10,width:400}} />
      ...
      onPress={() => Linking.openURL('https://www.calculatorsoup.com/calculators/discretemathematics/index.php')}>
    Calculator Soup
   </Text>
   </View>
   <Divider style={{marginTop:10,width:400}} />
         ...
         <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://www.rapidtables.com/convert/number/decimal-to-binary.html')}>
 Rapid Tables
   </Text>
   </View>
   <Divider style={{marginTop:10,width:400}} />
         ...
         <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://www.calculator.net/probability-calculator.html')}>
   Calculator.net
   </Text>
   </View>
