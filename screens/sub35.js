 ...
 return (
  ...
  <View style={styles.cont}>
   ...
   <Divider style={{marginTop:10,width:400}} />
      ...
      onPress={() => Linking.openURL('https://www.aelius.com/njh/subnet_sheet.html')}>
Subnet Mask Cheat Sheet
  ...
  <Divider style={{marginTop:10,width:400}} />
         ...
         <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://kthx.at/subnetmask/')}>
IPv4 Subnet Mask Cheat Sheet
  ...
  <Divider style={{marginTop:10,width:400}} />
         ...
         <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://dnsmadeeasy.com/support/subnet/')}>
   Dnsmadeasy
   </Text>
   </View>
  <Divider style={{marginTop:10,width:400}} />
         ...
         <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://www.subnetmask.info/')}>
   Network Calculator
   </Text>
   </View>
