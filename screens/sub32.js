 ...
 return (
  ...
  <View style={styles.cont}>
   ...
   <Divider style={{marginTop:10,width:400}} />
      ...
      onPress={() => Linking.openURL('https://open.umn.edu/opentextbooks/textbooks/352')}>
Computer Networking: Principles, Protocols, and Practice
   ...
   <Divider style={{marginTop:10,width:400}} />
         ...
         <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://www.ibm.com/cloud/learn/networking-a-complete-guide')}>
 IBM
   </Text>
   </View>
   <Divider style={{marginTop:10,width:400}} />
         ...
         <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://learnlearn.uk/alevelcs/network-topologies/')}>
   Learn Learn
   </Text>
   </View>
   <Divider style={{marginTop:10,width:400}} />
         ...
         <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('http://xn--julianmller-zhb.com/docs/UnixCommunicationFacilities/ip/node7.html')}>
