...
function Links({navigation}) {
 ...
 return (
  ...
  <StatusBar style="light"/>
     ...
     <TouchableOpacity style={styles.back} onPress={()=>navigation.navigate("sub26")}>

      <Text style={{paddingTop:30,width:400, textAlign:"center",color:"black"}} onPress={()=>navigation.navigate("sub26")}>Reading & Learning Guidance Material   </Text>
      </TouchableOpacity>
     
     
     
     <TouchableOpacity style={styles.back} onPress={()=>navigation.navigate("sub27")}>

      <Text style={{paddingTop:30,width:400,textAlign:"center",color:"black"}} onPress={()=>navigation.navigate("sub27")}> Discrete Mathematics Calculator</Text>
      </TouchableOpacity>
