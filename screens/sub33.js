 ...
 return (
  ...
  <View style={styles.cont}>
   ...
   <Divider style={{marginTop:10,width:400}} />
      ...
      onPress={() => Linking.openURL('https://www.cisco.com/')}>
Cisco
   </Text>
   </View>
   <Divider style={{marginTop:10,width:400}} />
         ...
         <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://www.juniper.net/us/en/products-services/nos/junos/')}>
Junos OS
   </Text>
   </View>
   <Divider style={{marginTop:10,width:400}} />
         ...
         <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://secure.paloalto.com/download_software/')}>
   Palo Alto
   </Text>
   </View>
   <Divider style={{marginTop:10,width:400}} />
         ...
         <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://www.fortinet.com/support/product-downloads')}>
   Fortinet
   </Text>
   </View>
