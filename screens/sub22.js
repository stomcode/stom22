...
function Links({navigation}) {
 ...
 <KeyboardAvoidingView  style={styles.container}>
  <StatusBar style="light"/>
     ...
     <TouchableOpacity style={styles.back} onPress={()=>navigation.navigate("sub23")}>

      <Text style={{paddingTop:30,width:400, textAlign:"center",color:"black"}} onPress={()=>navigation.navigate("sub23")}>Reading & Learning Guidance Material  </Text>
      </TouchableOpacity>
     
     
     <TouchableOpacity style={styles.back} onPress={()=>navigation.navigate("sub24")}>

      <Text style={{paddingTop:30,width:400,textAlign:"center",color:"black"}} onPress={()=>navigation.navigate("sub24")}> Download Software’s</Text>
      </TouchableOpacity>
