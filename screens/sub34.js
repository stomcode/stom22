 ...
 return (
  ...
  <View style={styles.cont}>
   ...
   <Divider style={{marginTop:10,width:400}} />
      ...
      onPress={() => Linking.openURL('https://www.calculator.net/ip-subnet-calculator.html')}>
Calculator Net
   </Text>
   </View>
  <Divider style={{marginTop:10,width:400}} />
         ...
         <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://www.site24x7.com/tools/ipv4-subnetcalculator.html')}>
Site24x7
   </Text>
   </View>
  <Divider style={{marginTop:10,width:400}} />
         ...
         <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://www.subnet-calculator.com/')}>
   Subnet Calculator
   </Text>
  </View>
  <Divider style={{marginTop:10,width:400}} />
         ...
         <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://subnet-calculator.samuraj-cz.com/')}>
   Samuraj
   </Text>
  </View> 
