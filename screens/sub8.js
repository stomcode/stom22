...
function Links({navigation}) {
 ...
 return (
  ...
  <Divider style={{marginTop:10,width:400}} />
      ...
      onPress={() => Linking.openURL('https://www.webfx.com/tools/read-able/')}>
   Webfx
   </Text>
   </View>
   <Divider style={{marginTop:10,width:400}} />
        ...
        <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://datayze.com/readability-analyzer.php')}>
 Datayze
   </Text>
   </View>
   <Divider style={{marginTop:10,width:400}} />
        ...
        <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://www.online-utility.org/english/readability_test_and_improve.jsp')}>
  Online Utility
   </Text>
   </View>
