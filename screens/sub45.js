...
function Links({navigation}) {
 ...
 return (
  ...
  <View style={styles.cont}>
      ...
      onPress={() => Linking.openURL('https://miro.com/templates/risk-matrix/')}>
Miro
   </Text>
   </View>
  <Divider style={{marginTop:10,width:400}} />
         ...
         <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://www.riskassessor.net/risk-assessment-software')}>
 Riskassessor
   </Text>
   </View>
  <Divider style={{marginTop:10,width:400}} />
         ...
         <Text style={{color:"black",textAlign:"center",width:400 }}
      onPress={() => Linking.openURL('https://www.simplerisk.com/solutions/risk-management')}>
   Simplerisk
   </Text>
   </View>
