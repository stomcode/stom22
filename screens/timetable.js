 ...
 return (
  ...
  <View style={styles.cont}>
   ...
   <Divider style={{marginTop:10,width:400}} />
         ...
         onPress={() => Linking.openURL('https://lahore.comsats.edu.pk/student/20210419-1630-Classes-UG.pdf')}>
Bachelor In Cyber Securitye
   </Text>
   </View>
   <Divider style={{marginTop:10,width:400}} />
         <View style={styles.back}>
...
{/* Different hyperlink for website */} 
